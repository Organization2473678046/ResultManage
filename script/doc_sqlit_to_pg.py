...
def get_sqlit_data(db_name, cur_pg):
    ...
    while True:
        ...
        if data:
            ...
            if sendouttime == None and recievetime != None:
                cur_pg.execute(
                    "INSERT INTO results_handoutlist (recievetime, title, signer, name, uniquenum, listnum, auditnum, secrecyagreementnum, purpose, sendunit, sendunitaddr, sendunitpostcode, receiveunit, receiveunitaddr, receiveunitpostcode, handler, handlerphonenum, handlermobilephonenum, receiver, receiverphonenum, receivermobilephonenum, sendouttimec, recievetimec, selfgetway, postway, networkway, sendtoway, signature, papermedia, cdmedia, diskmedia, networkmedia, othermedia, medianums, mapnums, filename, file, createtime, updatetime, isdelete) VALUES (%r,'%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', %r, %r, %r, %r, '%s', %r, %r, %r,  %r,  %r, '%s', '%s', '%s', '%s', %r, %r, %r)"% (recievetime, title, signer, name, uniquenum, listnum, auditnum, secrecyagreementnum, purpose, sendunit, sendunitaddr, sendunitpostcode, receiveunit, receiveunitaddr, receiveunitpostcode, handler, handlerphonenum, handlermobilephonenum, receiver, receiverphonenum, receivermobilephonenum, sendouttimec, recievetimec, selfgetway, postway, networkway, sendtoway, signature, papermedia, cdmedia, diskmedia, networkmedia, othermedia, medianums, mapnums, filename, file, createtime, updatetime, False))
            elif recievetime == None and sendouttime != None:
                cur_pg.execute(
                    "INSERT INTO results_handoutlist (sendouttime, title, signer, name, uniquenum, listnum, auditnum, secrecyagreementnum, purpose, sendunit, sendunitaddr, sendunitpostcode, receiveunit, receiveunitaddr, receiveunitpostcode, handler, handlerphonenum, handlermobilephonenum, receiver, receiverphonenum, receivermobilephonenum, sendouttimec, recievetimec, selfgetway, postway, networkway, sendtoway, signature, papermedia, cdmedia, diskmedia, networkmedia, othermedia, medianums, mapnums, filename, file, createtime, updatetime, isdelete) VALUES (%r,'%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', %r, %r, %r, %r, '%s', %r, %r, %r,  %r,  %r, '%s', '%s', '%s', '%s', %r, %r, %r)"% (sendouttime, title, signer, name, uniquenum, listnum, auditnum, secrecyagreementnum, purpose, sendunit, sendunitaddr, sendunitpostcode, receiveunit, receiveunitaddr, receiveunitpostcode, handler, handlerphonenum, handlermobilephonenum, receiver, receiverphonenum, receivermobilephonenum, sendouttimec, recievetimec, selfgetway, postway, networkway, sendtoway, signature, papermedia, cdmedia, diskmedia, networkmedia, othermedia, medianums, mapnums, filename, file, createtime, updatetime, False))
            elif sendouttime == None and recievetime == None:
                cur_pg.execute(
                    "INSERT INTO results_handoutlist (title, signer, name, uniquenum, listnum, auditnum, secrecyagreementnum, purpose, sendunit, sendunitaddr, sendunitpostcode, receiveunit, receiveunitaddr, receiveunitpostcode, handler, handlerphonenum, handlermobilephonenum, receiver, receiverphonenum, receivermobilephonenum, sendouttimec, recievetimec, selfgetway, postway, networkway, sendtoway, signature, papermedia, cdmedia, diskmedia, networkmedia, othermedia, medianums, mapnums, filename, file, createtime, updatetime, isdelete) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', %r, %r, %r, %r, '%s', %r, %r, %r,  %r,  %r, '%s', '%s', '%s', '%s', %r, %r, %r)"% (title, signer, name, uniquenum, listnum, auditnum, secrecyagreementnum, purpose, sendunit, sendunitaddr, sendunitpostcode, receiveunit, receiveunitaddr, receiveunitpostcode, handler, handlerphonenum, handlermobilephonenum, receiver, receiverphonenum, receivermobilephonenum, sendouttimec, recievetimec, selfgetway, postway, networkway, sendtoway, signature, papermedia, cdmedia, diskmedia, networkmedia, othermedia, medianums, mapnums, filename, file, createtime, updatetime, False))
            elif sendouttime != None and recievetime != None:
                cur_pg.execute(
                    "INSERT INTO results_handoutlist (sendouttime, recievetime, title, signer, name, uniquenum, listnum, auditnum, secrecyagreementnum, purpose, sendunit, sendunitaddr, sendunitpostcode, receiveunit, receiveunitaddr, receiveunitpostcode, handler, handlerphonenum, handlermobilephonenum, receiver, receiverphonenum, receivermobilephonenum, sendouttimec, recievetimec, selfgetway, postway, networkway, sendtoway, signature, papermedia, cdmedia, diskmedia, networkmedia, othermedia, medianums, mapnums, filename, file, createtime, updatetime, isdelete) VALUES (%r, %r,'%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', %r, %r, %r, %r, '%s', %r, %r, %r,  %r,  %r, '%s', '%s', '%s', '%s', %r, %r, %r)"% (sendouttime, recievetime, title, signer, name, uniquenum, listnum, auditnum, secrecyagreementnum, purpose, sendunit, sendunitaddr, sendunitpostcode, receiveunit, receiveunitaddr, receiveunitpostcode, handler, handlerphonenum, handlermobilephonenum, receiver, receiverphonenum, receivermobilephonenum, sendouttimec, recievetimec, selfgetway, postway, networkway, sendtoway, signature, papermedia, cdmedia, diskmedia, networkmedia, othermedia, medianums, mapnums, filename, file, createtime, updatetime, False))
        else:
            break
    ...
    while True:
        ...
        if data:
            ...
            cur_pg.execute(
                "INSERT INTO results_fileinfo (name, secretlevel, resultnum, datasize, formatormedia, remarks, handoutlist_uniquenum, createtime, updatetime, isdelete) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', %r, %r, %r)"% (name, secretlevel, resultnum, datasize, formatormedia, remarks, handoutlist_uniquenum, createtime, updatetime, False))
        else:
            break
...
def pg_conn(db_name):
    conn = psycopg2.connect(dbname=u"resmanagev2019.05.10",
                            user=u"postgres",
